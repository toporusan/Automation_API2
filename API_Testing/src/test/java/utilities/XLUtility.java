...
public class XLUtility {
    ...
    public int getCellCount(String sheetName, int rowNum) throws IOException {
        ...
        int cellCount = row.getLastCellNum();// count the cells
        workbook.close();
        fi.close();
        return cellCount;
    }
    ...
    public String getCellData(String sheetName, int rowNum, int colum) throws IOException {
        ...
        String data;
        try {
            data = formatter.formatCellValue(cell); // Returns the formatted values of cells as String
        } catch (Exception e) {
            data = "";
        }
        workbook.close();
    ...
    public void setCellData(String sheetName, int rowNum, int colum, String data) throws IOException {
        ...
        if (workbook.getSheetIndex(sheetName) == -1) { // if sheet not exist then create new row
